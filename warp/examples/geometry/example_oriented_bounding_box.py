...
# polyscope viewer.
#
#   uv run --with usd-core warp/examples/geometry/example_oriented_bounding_box.py
#   uv run --with usd-core --with polyscope warp/examples/geometry/example_oriented_bounding_box.py --polyscope
###########################################################################
