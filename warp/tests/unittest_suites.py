...
def default_suite(test_loader: unittest.TestLoader = unittest.defaultTestLoader):
    ...
    from warp.tests.geometry.test_connected_components import TestConnectedComponents
    ...
    from warp.tests.geometry.test_topology_statistics import TestTopologyStatistics
